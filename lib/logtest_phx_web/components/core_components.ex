defmodule LogtestPhxWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LogtestPhxWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LogtestPhxWeb.Gettext, "errors", msg, opts)
    end
  end
